...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.ab73e457.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.f8bbcaba.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.0e863d14.mjs.map
