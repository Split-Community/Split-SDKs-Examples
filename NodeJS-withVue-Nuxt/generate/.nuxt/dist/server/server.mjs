...
const welcome_vue_vue_type_style_index_0_scoped_a5ccb7ca_lang = "";
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a5ccb7ca"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.0e863d14.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
