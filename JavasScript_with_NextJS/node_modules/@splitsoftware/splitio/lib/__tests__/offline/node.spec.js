...
var spyTestImpressionsCount = _sinon.default.spy();
...
var configMocks = function configMocks() {
  ...
  _fetchMock.default.mock(settings.url('/testImpressions/count'), function () {
...
function DotYAMLTests(mockFileName, mockFileExt, assert) {
  ...
  client.on(client.Event.SDK_READY, function () {
    ...
    setTimeout(function () {
      factory.settings.features = _path.default.join(__dirname, "".concat(mockFileName, ".").concat(mockFileExt));
    }, 290);
    setTimeout(function () {
      factory.settings.features = _path.default.join(__dirname, "".concat(mockFileName, ".").concat(mockFileExt));
    }, 590);
    ...
    setTimeout(function () {
      factory.settings.features = _path.default.join(__dirname, "update.".concat(mockFileName, ".").concat(mockFileExt));
    }, 1000);
    client.once(client.Event.SDK_UPDATE, function () {
