...
function calculateSize(obj) {
  ...
  var keys = Object.keys(obj); // each string char counts as two bytes.

  var keysSize = keys.reduce(function (accum, key) {
    return accum + key.length * 2;
  }, 0);
  var valuesSize = keys.reduce(function (accum, key) {
...
var invalidValues = [[], function () {}, false, true, 'something', NaN, -Infinity, Infinity, new Promise(function (res) {
  return res;
}), Symbol('asd'), new Map()];
(0, _tapeCatch.default)('INPUT VALIDATION for Event Properties', function (t) {
  ...
  t.test('It should return the properties object when valid and also the correct event size, nulling any invalid prop', function (assert) {
    ...
    assert.deepEqual(output, {
      properties: _objectSpread(_objectSpread({}, providedProperties), {}, {
        willBeNulled1: null,
        willBeNulled2: null,
        willBeNulled3: null,
        willBeNulled4: null
    ...
    ['willBeNulled1', 'willBeNulled2', 'willBeNulled3', 'willBeNulled4'].forEach(function (key) {
