...
**/
(0, _tapeCatch.default)('MATCHER WHITELIST / should return true ONLY when the key is defined', function (assert) {
  var matcher = (0, _matchers.default)({
    type: _types.types.WHITELIST,
    value: new _Sets._Set().add('key')
  });
