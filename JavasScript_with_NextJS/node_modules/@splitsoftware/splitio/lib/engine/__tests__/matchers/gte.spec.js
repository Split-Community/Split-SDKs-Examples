...
**/
(0, _tapeCatch.default)('MATCHER GREATER THAN OR EQUAL / should return true ONLY when the value is greater than or equal to 10', function (assert) {
  var matcher = (0, _matchers.default)({
    negate: false,
    type: _types.types.GREATER_THAN_OR_EQUAL_TO,
    value: 10
  });
