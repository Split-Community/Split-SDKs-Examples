...
var _InRedis = _interopRequireDefault(require("../../../LatencyCache/InRedis"));
...
(0, _tapeCatch.default)('METRICS CACHE IN REDIS / should count based on ranges', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            assert.notEqual((0, _typeof2.default)(cache.clear), 'undefined', 'Clear method should be there to respect interface.');
            _context.next = 8;
