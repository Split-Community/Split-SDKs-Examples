...
var ioredisMock = (0, _reduce.default)([].concat(METHODS_TO_PROMISE_WRAP, ['disconnect']), function (acc, methodName) {
...
(0, _tapeCatch.default)('STORAGE Redis Adapter / Class', function (assert) {
  ...
  assert.true(instance._runningCommands instanceof _Sets._Set, 'The instance will have a set as the _runningCommands property.');
  assert.end();
});
...
(0, _tapeCatch.default)('STORAGE Redis Adapter / instance methods - _setTimeoutWrappers and queueing commands 1/2 - Error path', function (assert) {
  ...
  (0, _forEach.default)(METHODS_TO_PROMISE_WRAP, function (methodName) {
...
(0, _tapeCatch.default)('STORAGE Redis Adapter / instance methods - _setDisconnectWrapper', function (assert) {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      Promise.all((0, _Sets.setToArray)(instance._runningCommands)).catch(function (e) {
