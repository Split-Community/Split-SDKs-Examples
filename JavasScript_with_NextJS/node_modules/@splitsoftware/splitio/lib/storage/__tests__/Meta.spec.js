...
(0, _tapeCatch.default)('META / Meta object creation', function (assert) {
  var fakeSettings = {
  ...
  var meta = (0, _Meta.default)(fakeSettings);
  ...
  assert.true(meta !== (0, _Meta.default)(fakeSettings), 'Should return a new object each time we call it.');
  assert.end();
});