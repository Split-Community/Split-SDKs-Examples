...
tape('PARSER / if user.email starts with ["nico"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email = 123, starts with ["1"] then split 100:on should match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email starts with ["nico", "marcio", "facu"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email does not start with ["nico"] then not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is an EMPTY string, start with ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is not a string, start with ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email starts with ["nico"] then split 100:on, so not match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email does not start with ["nico"] should not match, then match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is an EMPTY string, start with ["nico"] should not match, so negation should', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is not a string, start with ["nico"] should not match, so negation should', /*#__PURE__*/function () {
...
tape('PARSER / if user.email ends with ["split.io"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email = 123, ends with ["3"] then split 100:on should match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email ends with ["gmail.com", "split.io", "hotmail.com"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email ends with ["gmail.com", "split.io", "hotmail.com"] but attribute is "" then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email does not end with ["split.io"] then not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is an EMPTY string, end with ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is not a string, end with ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email ends with ["split.io"] then split 100:on, so not match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email does not end with ["split.io"] then no match, so match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is an EMPTY string, end with ["nico"] should not match, so negation should', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is not a string, end with ["nico"] should not match, so negation should', /*#__PURE__*/function () {
...
tape('PARSER / if user.email contains ["@split"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email = 123, contains ["2"] then split 100:on should match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email contains ["@split"] (beginning) then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email contains ["@split"] (end) then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email contains ["@split"] (whole string matches) then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email contains ["@split", "@gmail", "@hotmail"] then split 100:on', /*#__PURE__*/function () {
...
tape('PARSER / if user.email does not contain ["@split"] then not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is an EMPTY string, contains ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / if user.email is not a string, contains ["nico"] should not match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email contains ["@split"] then split 100:on, then no match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email does not contain ["@split"] then not match, so match', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is an EMPTY string, contains ["nico"] should not match, so negation should', /*#__PURE__*/function () {
...
tape('PARSER / NEGATED if user.email is not a string, contains ["nico"] should not match, so negation should', /*#__PURE__*/function () {
