...
tape('PARSER / if user is in segment all 100%:on but trafficAllocation is 0%', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return evaluator(keyParser('a key'), 31, 0, 31);
...
tape('PARSER / if user is in segment all 100%:on but trafficAllocation is 99% with bucket below 99', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return evaluator(keyParser('a key'), 31, 99, 31);
...
tape('PARSER / if user is in segment all 100%:on but trafficAllocation is 99% and bucket returns 100', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return evaluator(keyParser('aaaaa'), 31, 99, 14);
...
tape('PARSER / if user is whitelisted and in segment all 100%:off with trafficAllocation as 0%', /*#__PURE__*/function () {
