...
tape('Counter / Impression Counter Test makeKey', function (assert) {
  var timestamp = new Date(2020, 9, 2, 10, 0, 0).getTime();
  var counter = new ImpressionCounter();
...
tape('Counter / Impression Counter Test BasicUsage', function (assert) {
