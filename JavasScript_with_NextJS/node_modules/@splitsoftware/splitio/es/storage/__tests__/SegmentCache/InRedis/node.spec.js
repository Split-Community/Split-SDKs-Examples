...
import SegmentCache from '../../../SegmentCache/InRedis';
...
tape('SEGMENT CACHE IN Redis / suite', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cache = new SegmentCache(keys, connection);
            _context.next = 5;
            return cache.flush();
...
tape('SEGMENT CACHE IN Redis / register segments', /*#__PURE__*/function () {
