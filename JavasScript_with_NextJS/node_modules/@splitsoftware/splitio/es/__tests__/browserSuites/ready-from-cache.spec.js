    ...
    fetchMock.get(testUrls.sdk + '/splitChanges?since=25', function () {
      return new Promise(function (res) {
        setTimeout(function () {
          return res({
            status: 200,
            body: _objectSpread(_objectSpread({}, splitChangesMock1), {}, {
              since: 25
            }),
            headers: {}
          });
    ...
    client3.on(client3.Event.SDK_READY, function () {
      client3.ready().then(function () {
        ...
        Promise.all([client3.destroy(), client2.destroy(), client.destroy()]).then(function () {
          ...
          t.true(nearlyEqual(parseInt(localStorage.getItem('readyFromCache_2.SPLITIO.splits.lastUpdated')), Date.now() - 800
    ...
    client3.on(client3.Event.SDK_READY, function () {
      client3.ready().then(function () {
        ...
        Promise.all([client3.destroy(), client2.destroy(), client.destroy()]).then(function () {
          ...
          t.true(nearlyEqual(parseInt(localStorage.getItem('readyFromCache_3.SPLITIO.splits.lastUpdated')), Date.now() - 800
          /* 800 ms between last Split and MySegments fetch */
    ...
    client3.on(client3.Event.SDK_READY, function () {
      client3.ready().then(function () {
        ...
        Promise.all([client3.destroy(), client2.destroy(), client.destroy()]).then(function () {
          ...
          t.true(nearlyEqual(parseInt(localStorage.getItem('readyFromCache_4.SPLITIO.splits.lastUpdated')), Date.now() - 1000
