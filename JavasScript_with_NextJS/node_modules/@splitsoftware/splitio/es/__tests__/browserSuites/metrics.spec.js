...
export default function metricsBrowserSuite(_x, _x2) {
  return _metricsBrowserSuite.apply(this, arguments);
}

function _metricsBrowserSuite() {
  _metricsBrowserSuite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(fetchMock, assert) {
