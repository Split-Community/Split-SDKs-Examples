        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            fetchMock.postOnce(settings.url('/testImpressions/count'), function (url, opts) {
              ...
              assert.equal(_typeof(notExistentSplitImpr.m), 'number');
          ...
          case 15:
            ...
            truncatedTimeFrame = truncateTimeFrame(readyEvaluationsStart); // depends on hierarchical_dep_hierarchical which depends on hierarchical_dep_always_on
