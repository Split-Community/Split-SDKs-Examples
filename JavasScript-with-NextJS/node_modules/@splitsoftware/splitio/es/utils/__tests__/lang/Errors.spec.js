...
tape('Language utils / Errors', function (assert) {
  var splitErrorInst = new SplitError(); // This one should not be used directly, so only testing default message

  var splitNetErrorInst = new SplitNetworkError();
  var splitTimeErrorInst = new SplitTimeoutError();
