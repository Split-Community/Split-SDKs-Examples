...
tape('MySegmentUpdateWorker', function (t) {
  // setup
  var cache = new MySegmentsCacheInMemory(new KeyBuilder(SettingsFactory()));
  var producer = ProducerMock();
  var mySegmentUpdateWorker = new MySegmentUpdateWorker(cache, producer);
