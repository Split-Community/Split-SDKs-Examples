...
tape('COUNT CACHE IN MEMORY / should count metric names incrementatly', function (assert) {
  var cache = new CountCacheInMemory();
...
tape('COUNT CACHE IN MEMORY / should support custom toJSON method', function (assert) {
  var cache = new CountCacheInMemory();
