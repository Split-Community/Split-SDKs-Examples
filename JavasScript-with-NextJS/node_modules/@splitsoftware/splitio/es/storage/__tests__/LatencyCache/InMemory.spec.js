...
tape('METRICS CACHE IN MEMORY / should count based on ranges', function (assert) {
  var metricName = 'testing';
  var c1 = new LatencyCacheInMemory();
...
tape('METRICS CACHE IN MEMORY / clear', function (assert) {
  var metricName = 'testing';
  var c1 = new LatencyCacheInMemory();
...
tape('METRICS CACHE IN MEMORY / should support custom toJSON method', function (assert) {
  var c = new LatencyCacheInMemory();
