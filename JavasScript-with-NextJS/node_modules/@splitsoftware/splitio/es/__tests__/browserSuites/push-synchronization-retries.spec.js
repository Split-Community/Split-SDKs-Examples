...
import Backoff from '../../utils/backoff'; // Replace original EventSource with mock
...
var MILLIS_MYSEGMENT_UPDATE_EVENT = 500;
var MILLIS_THIRD_RETRY_FOR_MYSEGMENT_UPDATE_EVENT = 1200;
...
export function testSynchronizationRetries(fetchMock, assert) {
  ...
  var ORIGINAL_DEFAULT_BASE_MILLIS = Backoff.DEFAULT_BASE_MILLIS;
