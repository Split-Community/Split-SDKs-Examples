...
export function testFallbacking(fetchMock, assert) {
  ...
  setMockListener(function (eventSourceInstance) {
    ...
    setTimeout(function () {
      ...
      setMockListener(function (eventSourceInstance) {
        var expectedSSEurl = "".concat(settings.url('/sse'), "?channels=NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_MjE0MTkxOTU2Mg%3D%3D_mySegments,NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_NTcwOTc3MDQx_mySegments,NzM2MDI5Mzc0_NDEzMjQ1MzA0Nw%3D%3D_splits,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_pri,%5B%3Foccupancy%3Dmetrics.publishers%5Dcontrol_sec&accessToken=").concat(authPushEnabledNicolasAndMarcio.token, "&v=1.1&heartbeats=true");
  ...
  fetchMock.getOnce(settings.url("/auth?users=".concat(encodeURIComponent(userKey), "&users=").concat(encodeURIComponent(secondUserKey))), function (url, opts) {
    ...
    return {
      status: 200,
      body: authPushEnabledNicolasAndMarcio
    };
  });
  fetchMock.getOnce(settings.url('/splitChanges?since=1457552620999'), {
    status: 200,
