...
tape('NodeJS Redis', function (t) {
  ...
  t.test('Connection ready and timed out', function (assert) {
    ...
    var sdk = SplitFactory(configWithShortTimeout);
    ...
    client.ready().catch(function () {
      var delay = Date.now() - start;
      assert.true(nearlyEqual(delay, readyTimeout * 1000), 'Ready promise must be rejected after 100 millis'); // initialize server to emit SDK_READY
    ...
    client.on(client.Event.SDK_READY, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      var delay;
    ...
    client.on(client.Event.SDK_READY, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              sdk2 = SplitFactory(configWithVeryShortTimeout);
              client2 = sdk2.client();
              client2.on(client2.Event.SDK_READY_TIMED_OUT, function () {
                assert.pass('SDK_READY_TIMED_OUT event must be emitted');
              });
              client2.on(client2.Event.SDK_READY, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
  ...
  t.test('Connection error', function (assert) {
    initializeRedisServer().then(function (server) {
      ...
      var start = Date.now();
      client.once(client.Event.SDK_READY, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
        var delay;
  ...
  t.test('Calling destroy with pending operations', function (assert) {
    initializeRedisServer().then( /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(server) {
        var sdk, client;
        return _regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                sdk = SplitFactory(_objectSpread(_objectSpread({}, config), {}, {
  ...
  t.test('Check IP and Hostname in Redis', function (assert) {
    initializeRedisServer().then( /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(server) {
