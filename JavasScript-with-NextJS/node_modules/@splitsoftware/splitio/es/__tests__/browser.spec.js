...
tape('## E2E CI Tests ##', function (assert) {
  ...
  fetchMock.get(settings.url('/mySegments/marcio%40split.io'), {
    status: 200,
  ...
  assert.test('E2E / Fetch specific splits', fetchSpecificSplits.bind(null, fetchMock)); //If we change the mocks, we need to clear localstorage. Cleaning up after testing ensures "fresh data".
