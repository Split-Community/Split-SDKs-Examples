...
tape('IF ELSE IF COMBINER / should correctly propagate context parameters and predicates returns value', /*#__PURE__*/function () {
...
tape('IF ELSE IF COMBINER / should stop evaluating when one matcher return a treatment', /*#__PURE__*/function () {
...
tape('IF ELSE IF COMBINER / should return undefined if there is none matching rule', /*#__PURE__*/function () {
