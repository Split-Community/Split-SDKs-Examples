...
function configFilesPath() {
  ...
  if (!((0, _lang.endsWith)(configFilePath, '.yaml', true) || (0, _lang.endsWith)(configFilePath, '.yml', true) || (0, _lang.endsWith)(configFilePath, '.split', true))) throw "Invalid extension specified for Splits mock file. Accepted extensions are \".yml\" and \".yaml\". Your specified file is ".concat(configFilePath);
  if (!_fs.default.existsSync(configFilePath)) throw "Split configuration not found in ".concat(configFilePath, " - Please review your Split file location.");
...
var _default = getSplitConfigForFile;
