...
function _default(fetchMock, assert) {
  ...
  function mockForSegmentsPauseTest(testUrls) {
    ...
    if (startWithSegments) {
      ...
      fetchMock.get(testUrls.sdk + '/splitChanges?since=1457552620999', {
        status: 200,
        body: _objectSpread(_objectSpread({}, _splitchangesRealUpdateWithoutSegments.default), {}, {
          since: 1457552620999,
          till: 1457552649999
        })
      });
      fetchMock.get(testUrls.sdk + '/splitChanges?since=1457552649999', {
        status: 200,
        body: _objectSpread(_objectSpread({}, _splitchangesRealUpdateWithSegments.default), {}, {
          since: 1457552649999,
          till: 1457552669999
        })
      });
