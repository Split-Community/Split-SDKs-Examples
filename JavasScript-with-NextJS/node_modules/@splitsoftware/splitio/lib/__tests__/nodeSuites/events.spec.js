...
exports.default = trackAssertions;
...
function trackAssertions(fetchMock, assert) {
  ...
  assert.equal((0, _typeof2.default)(client.track), 'function', 'client.track should be a function.');
