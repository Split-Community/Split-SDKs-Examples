...
**/
(0, _tapeCatch.default)('TREATMENTS / parse 2 treatments', function (assert) {
  var t = _treatments.default.parse([{
    treatment: 'on',
    size: 5
  }, {
    treatment: 'control',
...
(0, _tapeCatch.default)('TREATMENTS / parse 1 treatment 100%:on', function (assert) {
  var t = _treatments.default.parse([{
    treatment: 'on',
    size: 100
  }]);
...
(0, _tapeCatch.default)('TREATMENTS / parse 1 treatment 100%:off', function (assert) {
  var t = _treatments.default.parse([{
    treatment: 'control',
    size: 100
  }]);
...
(0, _tapeCatch.default)('TREATMENTS / given a 50%:visa 50%:mastercard we should evaluate correctly', function (assert) {
  var t = _treatments.default.parse([{
    treatment: 'visa',
    size: 50
  }, {
