...
**/
(0, _tapeCatch.default)('MATCHER ENDS_WITH / should return true ONLY when the value ends with ["a", "b", "c"]', function (assert) {
  var matcher = (0, _matchers.default)({
    negate: false,
    type: _types.types.ENDS_WITH,
    value: ['a', 'b', 'c']
  });
...
(0, _tapeCatch.default)('MATCHER ENDS_WITH / should return true ONLY when the value ends with ["demo.test.org"]', function (assert) {
  var matcher = (0, _matchers.default)({
    negate: false,
    type: _types.types.ENDS_WITH,
    value: ['demo.test.org']
