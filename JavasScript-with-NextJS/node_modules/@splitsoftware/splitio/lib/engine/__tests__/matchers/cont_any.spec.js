...
**/
(0, _tapeCatch.default)('MATCHER CONTAINS_ANY_OF_SET / should return true ONLY when value contains any of set ["update", "add"]', function (assert) {
  var matcher = (0, _matchers.default)({
    negate: false,
    type: _types.types.CONTAINS_ANY_OF_SET,
    value: ['update', 'add']
  });
