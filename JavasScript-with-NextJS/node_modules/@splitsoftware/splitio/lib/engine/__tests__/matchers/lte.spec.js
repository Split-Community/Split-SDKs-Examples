...
**/
(0, _tapeCatch.default)('MATCHER LESS THAN OR EQUAL / should return true ONLY when the value is less than or equal to 10', function (assert) {
  var matcher = (0, _matchers.default)({
    negate: false,
    type: _types.types.LESS_THAN_OR_EQUAL_TO,
    value: 10
  });
