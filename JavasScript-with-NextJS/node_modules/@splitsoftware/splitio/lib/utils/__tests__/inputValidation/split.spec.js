...
var LabelConstants = _interopRequireWildcard(require("../../labels"));
...
(0, _tapeCatch.default)('INPUT VALIDATION for Split name and Split existance (special case)', function (t) {
  ...
  t.test('Should return a boolean indicating if the SDK was ready and there was no Split object or "definition not found" label', function (assert) {
    var contextMock = {
      get: _sinon.default.stub().returns(false),
