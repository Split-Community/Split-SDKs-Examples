...
(0, _tapeCatch.default)('SPLIT CACHE / In Memory', function (assert) {
...
(0, _tapeCatch.default)('SPLIT CACHE / In Memory / Get Keys', function (assert) {
  var cache = new _InMemory.default();
  cache.addSplit('lol1', '{ "name": "something"}');
  cache.addSplit('lol2', '{ "name": "something else"}');
...
(0, _tapeCatch.default)('SPLIT CACHE / In Memory / trafficTypeExists and ttcache tests', function (assert) {
  var cache = new _InMemory.default();
...
(0, _tapeCatch.default)('SPLIT CACHE / In Memory / killLocally', function (assert) {
  var cache = new _InMemory.default();
  cache.addSplit('lol1', '{ "name": "something"}');
  cache.addSplit('lol2', '{ "name": "something else"}');
