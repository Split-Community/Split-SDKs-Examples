...
import { m as mergedTypes, c as getTypeDescriptor, b as normalizeTypes, f as cachedFn } from './shared/untyped.ffb7db28.mjs';
import 'scule';
...
function parseJSDocs(input) {
  ...
  const lines = (Array.isArray(input) ? input : [input]).flatMap((c) => c.split("\n").map((l) => l.replace(/(^\s*\*+ )|([\s*]+$)/g, "")));
